            ...
            <Container className="py-12 sm:py-22">
                <div className="mx-auto w-full max-w-md sm:max-w-lg rounded-2xl bg-[var(--white)] p-6 sm:p-8 ring-1 ring-black/10">
                    <div className="text-center">
                        ...
                        <p className="mt-2 text-sm text-[var(--text-muted)]">Continue your emotional journey.</p>
                    </div>
                    ...
                    <form className="mt-6 space-y-4" onSubmit={handleSubmit}>
                        ...
                        <div className="flex items-center justify-between">
                            <label className="flex items-center gap-2 text-sm text-[var(--text-dark)]">
                                <input type="checkbox" id="remember" name="remember" className="h-4 w-4 rounded border border-black/10 bg-[var(--white)]" />
                                Remember me
                            </label>
                            <Link href="#" className="text-sm text-[var(--text-muted)] underline-offset-4 hover:text-[var(--text-dark)]">Forgot password?</Link>
                        </div>
                        <button
                            type="submit"
                            className="mt-2 w-full rounded-xl bg-[var(--primary)] px-4 py-2 text-white hover:bg-[var(--primary-hover)]"
                        >
                            Sign In
                        </button>
                    </form>
                    ...
                    <div className="mt-4 grid gap-3 sm:grid-cols-2">
                        <button
                            type="button"
                            className="flex items-center justify-center gap-2 rounded-xl bg-[var(--white)] px-4 py-2 text-sm font-medium text-black ring-1 ring-black/10 hover:bg-white/90"
                    ...
                    <div className="mt-6 text-center text-sm text-[var(--text-muted)]">
                        Don’t have an account? <Link href="/register" className="hover:text-[var(--text-dark)]">Create one</Link>
                    </div>
                </div>
            </Container>
        </div>
